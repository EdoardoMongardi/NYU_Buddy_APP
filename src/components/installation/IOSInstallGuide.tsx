 ...
 * Shows step-by-step visual guide for installing PWA on iOS Safari
 */
...
export default function IOSInstallGuide({ isOpen, onClose }: IOSInstallGuideProps) {
  ...
  const steps = [
    ...
    },
    {
      icon: Home,
      title: 'Tap Add',
      description: 'Tap "Add" in the top right, then open from home screen',
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
              <div className="flex items-start gap-2 mb-4">
                ...
                <p className="text-xs text-gray-600 leading-relaxed">
                  <strong className="text-gray-900">Why install?</strong><br />
                  Installing enables push notifications, offline access, and a faster, app-like experience.
                </p>
              </div>
